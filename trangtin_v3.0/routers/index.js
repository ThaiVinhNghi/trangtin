...
router.get('/baiviet/chude/:id', async (req, res) => {
    ...
    res.render('baiviet_chude', {
        ...
        baiviet: bv,
        xemnhieunhat: xnn,
        firstImage: firstImage // Lưu ý: biến firstImage chưa được định nghĩa trong đoạn code trên
    });
});
...
router.get('/baiviet/chitiet/:id', async (req, res) => {
    ...
    // (Lưu ý: Bạn có thể thêm code cập nhật lượt xem ở đây, ví dụ: 
    ...
    res.render('baiviet_chitiet', {
        ...
        baiviet: bv,
        xemnhieunhat: xnn,
        firstImage: firstImage // Lưu ý: biến firstImage vẫn chưa thấy khai báo phía trên
    });
});
